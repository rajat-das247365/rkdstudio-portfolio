  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200 font-mono flex justify-between">
      ...
      <div className="w-[80%] flex flex-col items-center">
        ...
        {/* Hero Nav */}
        <div className="sticky top-14 w-[60%] h-10 border border-slate-800 mt-10 flex justify-around items-center bg-[repeating-linear-gradient(135deg,rgba(255,255,255,0.04)_0,rgba(255,255,255,0.09)_1px,transparent_1px,transparent_8px)] ">
          <Link
