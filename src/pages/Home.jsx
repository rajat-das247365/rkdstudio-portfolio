...
const Home = () => {
  const linkClass = "text-[#63D0FF] font-semibold text-l hover:text-slate-200";

  const activeClass = "text-slate-200 font-bold";
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200 font-mono flex justify-between">
      ...
      <div className="w-full flex flex-col items-center">
        {/* Hero Nav */}
        <div className=" w-full h-15 text-sm md:text-xl border border-slate-800 mt-10 flex sm:gap-5 justify-around items-center bg-[repeating-linear-gradient(135deg,rgba(255,255,255,0.04)_0,rgba(255,255,255,0.09)_1px,transparent_1px,transparent_8px)] ">
          <NavLink
